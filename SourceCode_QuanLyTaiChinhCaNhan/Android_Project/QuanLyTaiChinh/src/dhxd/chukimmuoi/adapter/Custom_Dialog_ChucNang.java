...
public class Custom_Dialog_ChucNang extends ArrayAdapter<item_chucnang> {

	private Context context;
	private int layoutId;
	private ArrayList<item_chucnang> list_itemChuNang;
	static final int[] Anh = Icon_MenuItem.anhchucnang;

	public Custom_Dialog_ChucNang(Context context, int resource,
