...
public class Custom_Dialog_ChucNang_ChuyenTien extends ArrayAdapter<item_chucnang> {

	private Context context;
	private int layoutId;
	private ArrayList<item_chucnang> list_itemChuNang;
	static final int[] Anh = Icon_MenuItem.anhchucnang_chuyentien;

	public Custom_Dialog_ChucNang_ChuyenTien(Context context, int resource,
