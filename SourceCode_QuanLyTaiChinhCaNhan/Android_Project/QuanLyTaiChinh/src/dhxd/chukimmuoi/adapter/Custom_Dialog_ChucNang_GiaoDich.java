...
public class Custom_Dialog_ChucNang_GiaoDich extends ArrayAdapter<item_chucnang> {

	private Context context;
	private int layoutId;
	private ArrayList<item_chucnang> list_itemChuNang;
	static final int[] Anh = Icon_MenuItem.anhchucnang_giaodich;

	public Custom_Dialog_ChucNang_GiaoDich(Context context, int resource,
