...
public class Custom_Dialog_ChucNang_KeHoachCongViec extends ArrayAdapter<item_chucnang> {

	private Context context;
	private int layoutId;
	private ArrayList<item_chucnang> list_itemChuNang;
	static final int[] Anh = Icon_MenuItem.anhchucnang_kehoachcongviec;

	public Custom_Dialog_ChucNang_KeHoachCongViec(Context context, int resource,
