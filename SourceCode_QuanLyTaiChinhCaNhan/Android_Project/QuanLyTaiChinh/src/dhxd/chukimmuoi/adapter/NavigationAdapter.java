...
public class NavigationAdapter extends BaseAdapter {
	...
	// THIẾT LẬP TRUYỀN SỐ ĐẾM
	public void setDownloadsCounter(int count) {
		mDownloadsCounter = count;
		mList.get(Constant.MENU_THONGBAO).counter = mDownloadsCounter;
		notifyDataSetChanged();
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.viewNavigation = (View) convertView
					.findViewById(R.id.viewNavigation);

			holder.colorLinear = (LinearLayout) convertView
		...
		if (!item.isHeader) {
			...
			convertView
					.setBackgroundResource(R.drawable.seletor_item_navigation);
		}
