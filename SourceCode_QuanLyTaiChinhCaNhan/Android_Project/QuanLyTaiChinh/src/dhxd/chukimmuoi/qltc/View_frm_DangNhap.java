...
public class View_frm_DangNhap extends Activity {

	Button dangky, dangnhap, quenmatkhau;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.view_frm_dangnhap);

		dangky = (Button) findViewById(R.id.btnDangKy_DN);
		dangnhap = (Button) findViewById(R.id.btnDangNhap_DN);
		quenmatkhau = (Button) findViewById(R.id.btnQuenMatKhau_DN);
		email = (EditText) findViewById(R.id.etEmail_DN);
		matkhau = (EditText) findViewById(R.id.etMatKhau_DN);
		...
		dangnhap.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if ((!email.getText().toString().equals(""))
					...
					new DangNhap().execute();
				} else {
					Toast.makeText(getApplicationContext(),
							"Bạn chưa nhập đủ thông tin cần thiết.",
		...
		dangky.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent myIntent = new Intent(View_frm_DangNhap.this,
						View_frm_DangKy.class);
	...
	private class DangNhap extends AsyncTask<String, String, JSONObject> {
		private ProgressDialog pDialog;

		@Override
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(View_frm_DangNhap.this);
			...
			if (netInfo != null && netInfo.isConnected()) {
				try {
					...
					if (httpUrlConn.getResponseCode() == 200) {
						...
						JSONObject objJSON = ctrND.DangNhap(tblND);
						return objJSON;
					}
